          ...
          <div class="col-md-12" id="addForm">
              ...
              @if($model == 'ArEmplacement')
                  <div class="form-group">
                      ...
                      <select id="type_archive" disabled name="type_archive" class="form-control bordered" > 
                          <option value="1" @if($listes->type_archive == 1) selected="selected" @endif>{{ trans('text_archive.actif') }}</option>
                          <option value="2" @if($listes->type_archive == 2) selected="selected" @endif>{{ trans('text_archive.demi_actif') }}</option>
                          <option value="3" @if($listes->type_archive == 3) selected="selected" @endif>{{ trans('text_archive.definitif') }}</option>
                      </select>
                  </div>
              @endif
              <div class="form-group ">
