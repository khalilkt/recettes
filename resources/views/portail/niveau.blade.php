    ...
    <div class="card  souscond_tb kk " >
        <div class="card-header"  role="tab" id="headingOne4">
            ...
            <h4 class="card-title">
                ...
                <a class="collapsed " role="button" data-toggle="collapse" data-parent="#tb" href="#tb" aria-expanded="false" aria-controls="tb"  onclick="plus_info_commune(this,{ <?php echo $getcolor; ?> },'{{ $module }}','{{ $ref }}','{{ $niveau }}')">
    ...
    <script type="text/javascript">
        ...
        var groupedOverlays = {
           ...
           /* "<b style=color:rgb(220,31,37);>Activités</b> <br>": {
            ...
            "<b style=color:rgb(220,31,37);>Météo</b>": {
                "Météo actuelle":   city,
                "Précipitation": prec,
                "Pluie": plui,
