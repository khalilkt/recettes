...
<form method="get" action="#">
    <div class="row ">
        ...
        <div class="col-md-3">
            <div class="row">
                <div class="col-md-12 p-0">
                    <div class="left-side-bloc" >
                        <h6><i class="fa fa-calendar"></i> Périodicité</h6>
                        <div class="row">
                            <div class="col-md-6 pr-0" style="display: inline-block">

                                <input class="form-control" name="ref_deb" id="ref_deb" type="date" onchange="getCount()"  value="{{ date('Y') }}-01-01" style="line-height: 2.3!important;">
                            ...
                            <div class="col-md-6 pl-0">
                                ...
                                <input class="form-control" name="ref_fin" id="ref_fin" type="date" onchange="getCount()" value="{{ date('Y') }}-12-31" style="line-height: 2.3!important;" >
                            <!-- <input type="date" class="form-control" name="ref" id='ref' value="<?php echo date('Y-m-d');?>" onchange="filter(niveau_geo.value,this.value,legend.value,filtre_pop.value,filtre_notp.value,filtre_cond.value,filtre_pop1.value,filtre_pop2.value)" />-->
                            </div>
            ...
            <div class=" left-side-bloc">
                ...
                <div id="legend_pers">
                    <select class="form-control select2" name="legend" id="legend" onchange="getCount()">
                        <option value="1">Priorités</option>
                        <option value="2">Avancements</option>
                    </select>
        ...
        <div class=" left-side-bloc-t col-md-3">
            ...
            <a href="{{ url('/') }}" class="btn btn-info btn-block ">{{ trans('text_me.indicateure') }}</a>
