...
@section('top-page-btn')
    ...
    @if(Auth::user()->hasAccess(5,2))
        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" onclick="openFormAddInModal('equipements')"><i class="fas fa-plus fa-sm text-white-50"></i> {{trans("text_me.add_equipement")}}</a>
    @endif
@endsection
