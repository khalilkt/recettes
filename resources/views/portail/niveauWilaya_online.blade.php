    ...
    <div class="panel-heading"  role="tab" id="headingOne4">
        ...
        <h4 class="panel-title">
            ...
            <a class="collapsed " role="button" data-toggle="collapse" data-parent="#tb" href="#tb" aria-expanded="false" aria-controls="tb"  onclick="plus_info_commune(this,{ <?php echo $getcolor; ?> },'{{ $module }}','{{ $ref }}',3)">
                <i class="more-less fa fa-plus " ></i> Voir le résultat
            </a>
            <button type="button" onclick="export_tab_commune(this,{ <?php echo $getcolor; ?> },'{{ $module }}','{{ $ref }}')" class="btn btn-success pull-right exp_fiche_excel" style="padding: 3px 6px;font-size: 12px;margin-top: -5px;"><i class="fa fa-file-excel-o exp_excel"></i> Exporter</button>
        </h4>
...
//alert(zoomLev);
  ...
  /*  map.on('zoomend', function () {
    ...
    function coordonne_parc()
    {

       alert(coordonnee_gps_zone_humide());

        /*var coordinates = [
           res_zone
        ];*/
      //alert($("#marker").val());
        var coordinates = coordonnee_gps_zone_humide();
        return  coordinates;
