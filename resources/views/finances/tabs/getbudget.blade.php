<div class="modal-header">
    <h5 class="modal-title">{{ trans('text_me.modifier_budget') }}</h5>
...
<div class="modal-body">
    <div class="row">
        <div class="col-md-12" id="addForm">
            <form class="" action="{{ url('finances/editbudget') }}" method="post">
                {{ csrf_field() }}
                <div class="form-row">
                    <div class="col-md-6 form-group">
                        ...
                        <input id="libelle" name="libelle" class="form-control" value="{{$budget->libelle}}">
                    </div>
                    <div class="col-md-6 form-group">
                        ...
                        <input id="libelle_ar" name="libelle_ar" class="form-control" value="{{$budget->libelle_ar}}">
                    </div>
                    <input type="hidden" value="{{$budget->id}}" name="id">
                    <input type="hidden" value="{{$budget->id}}" name="annee">
                    <input type="hidden" value="{{$budget->id}}" name="ordre">
                    <div class="col-md-12 form-row">
                        ...
                        <div class="col-md-4 form-group text-right">
                            <button class="btn btn-success btn-icon-split" onclick="editbudget(this)" container="addForm">
