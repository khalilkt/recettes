...
L.OWM.Current = L.Layer.extend({
    ...
    options: {
        ...
        imageLoadingUrl: 'vendor/leaflet/images/owmloading.gif', // URL of loading image relative to HTML document
        imageLoadingBgUrl: 'vendor/leaflet/images/10d.png', // URL of background image for progress control
